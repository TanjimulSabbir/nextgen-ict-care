    ...
    < div className="grid lg:grid-cols-2 gap-16 items-start bg-white/2 border border-white/5 max-w-7xl mx-auto mb-20 px-8 md:p-16 rounded-[4rem]" >
      ...
      < div >
        ...
        <div className="space-y-10 relative">
          <div className="absolute left-4.75 top-2 bottom-2 w-0.5 bg-dashed bg-cyan-500/20 border-l-2 border-dashed border-cyan-500/30" />
          ...
          {[
            ...
            { icon: <FaUserTie />, title: "ক্লাস শুরু", desc: "নির্ধারিত তারিখে চলে আসুন আমাদের ইন্টারেক্টিভ অফলাইন ক্লাসে।" }
          ].map((step, i) => (
