    ...
    const courses = [
        {
            ...
            topics: ["সংখ্যা পদ্ধতির জাদুকরী ট্রিকস", "লজিক গেট ও সার্কিট ডিজাইন", "প্রোগ্রামিংয়ের হাতেখড়ি", "ওয়েব ডিজাইনের বেসিক", "সকল আইসিটি অধ্যায়","সকল অধ্যায় একদম বেসিক থেকে শিখানো হবে"],
        ...
        },
        {
            ...
            topics: ["সহ আগের সব টপিকস", "অ্যাডভান্সড C-Programming", "SQL ও ডেটাবেজ ম্যানেজমেন্ট", "বোর্ড প্রশ্ন ব্যবচ্ছেদ", "যোগাযোগ ও নেটওয়ার্কিং"],
        ...
        },
        {
            ...
            topics: [,"সম্পূর্ণ সিলেবাস রিভিশন","এক্সামে কমন পরে এধরনের বাছায় করা সাজেশন", "MCQ সলভিং সুপার ট্রিকস", "ফুল মডেল টেস্ট সিরিজ", "সময় ব্যবস্থাপনা কৌশল"],
            poster: HscExamBatch,
            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {courses.map((course, index) => (
                        <div
                            key={index}
                            className="group relative bg-white/3 border border-white/10 rounded-[2.5rem] overflow-hidden transition-all duration-500 hover:border-cyan-500/40 hover:-translate-y-3"
                        >
                            {/* Card Image Section */}
                            <div className="relative h-64 overflow-hidden">
                                ...
                                {/* Status Tags */}
                                <span className="absolute top-5 left-5 bg-cyan-600/10 backdrop-blur-md border border-white/10 text-cyan-400 text-[10px] font-bold px-3 py-1 rounded-full uppercase tracking-widest">
                                    {course.learningCurve}
                                </span>
                                {course.tag && (
                                    <span className="absolute top-5 right-5 bg-cyan-500 text-black text-[10px] font-black px-3 py-1 rounded-full shadow-lg">
                                        {course.tag}
                                    </span>
                                )}
                            </div>
                            ...
                            <div className="p-8">
                                <div className="mb-4">
                                    <h4 className="text-cyan-500 text-xs font-bold uppercase tracking-widest mb-1">{course.subTitle}</h4>
                                ...
                                <div className="space-y-3 mb-8">
                                    {course.topics.slice(0, 7).map((topic, i) => (
                                ...
                                <Link
                                    ...
                                    className="flex items-center justify-center gap-3 w-full hover:bg-white text-black py-4 rounded-2xl font-bold bg-cyan-500 hover:text-black transition-all duration-300 group/btn"
                                >
                                    বিস্তারিত দেখুন
